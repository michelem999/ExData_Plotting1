...
## Convertion of the class of the Time colum with as.POSIXct(), including also the date in the time 
## (by concatenating date and time before the conversion) 
...
## Set local time formato to US, in order to avoid non-English names of weekdays (Otherwise they appear in Italian/Spanish,...)
...
plot(initialFebr0102$Time, initialFebr0102$Global_active_power, type="l",cex.lab=.8, font.lab=2, cex.main=1, cex.axis=.8, font.axis=2 ,xlab="", ylab="Global Active Power")
